              ...
              <div className="space-y-6 text-base sm:text-lg leading-[1.8] text-zinc-400 text-justify">
                ...
                <div className="pt-4 flex">
                  <a 
                    ...
                    className="inline-flex items-center gap-3 px-6 py-3 rounded-md border border-zinc-800/80 bg-[#0a0a0a] hover:bg-[#111111] hover:border-[var(--accent-rust)] hover:text-white transition-all text-xs font-mono uppercase tracking-[0.15em] text-zinc-300 group shadow-sm"
                  >
                    View Resume
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-500 group-hover:text-[var(--accent-rust)] transition-colors">
